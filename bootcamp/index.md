...
Since we have limited class time be sure you have R and RStudio downloaded and operational **before** class.  You can find instructions to install R and RStudio at [http://uc-r.github.io/section2_basics#installation](http://uc-r.github.io/section2_basics#installation).  You will want to make sure your version of R is >= 3.4 and RStudio is >= 1.0.143. 
